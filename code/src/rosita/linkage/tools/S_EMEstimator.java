...
public class S_EMEstimator {
	...
	public double[] runEMMethodBlocking(DataRow[][] rowsA, DataRow[][] rowsB, AbstractJoinCondition cond, double p) {
		...
		PPRLDistance pprld = new PPRLDistance(((S_WeightedJoinCondition)this.condition).getPPRLThreshold()); 
	...
	public static void main(String[] args) {
		...
		S_EMEstimator estimator = new S_EMEstimator();
		EMIteration iter = new EMIteration();
		iter.m = m;
		iter.u = u;
		iter.p = p;

...
public class S_EditDistance extends AbstractStringDistance {

	private static final int logLevel = Log.getLogLevel(S_EditDistance.class);
	...
	public static class EditDistanceVisibleComponent extends GUIVisibleComponent {
		...
		public Object generateSystemComponent() throws RJException, IOException {
			return new S_EditDistance(panel.getParams());
		}
	...
	public S_EditDistance() {
		super(null);
		Log.log(getClass(), "Approve level=" + APPROVE, 1);
	}
	
	public S_EditDistance(Map props) {
		super(props);
	...
	public double distance(DataCell cell1, DataCell cell2) {
		String str1 = getStringTrueValue(cell1.getValue().toString());
		String str2 = getStringTrueValue(cell2.getValue().toString());
		return distance(str1, str2);
	}
	
	public String getStringTrueValue(String parStr){
		
		String result = parStr;
		if(parStr.contains("Cell[value='")){
	...
	public static void main(String[] args) {
		...
		S_EditDistance ed = new S_EditDistance(props);

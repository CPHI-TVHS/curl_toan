...
public class AbstractStatement implements  java.sql.Statement{
	
	private Statement _statement;

	public AbstractStatement(Callable< java.sql.Statement> statementCreation) throws SQLException {
		try {
			_statement = statementCreation.call();
		} catch (Exception e) {
	...
	public boolean isWrapperFor(Class<?> arg0) throws SQLException {
		...
		return _statement.isWrapperFor(arg0);
	}

	@Override
	public <T> T unwrap(Class<T> arg0) throws SQLException {
		
		return _statement.unwrap( arg0);
	}
